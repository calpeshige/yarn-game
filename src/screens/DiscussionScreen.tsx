...
export function DiscussionScreen() {
  ...
  return (
    <div className="screen-container relative mt-4">
      <motion.div
        className="w-full bg-white/70 backdrop-blur-xl rounded-3xl p-6 mb-4 text-center shadow-[0_8px_30px_rgba(0,0,0,0.06)] border border-white/60 relative overflow-hidden"
      ...
      >
        <button
          className="text-xs font-bold text-text-secondary hover:text-blue bg-white/50 hover:bg-white/80 backdrop-blur-sm border border-white/60 shadow-sm px-4 py-2 rounded-full transition-all"
          onClick={() => navigate('/theme')}
        >
          {t('discussion.reselectTheme')}
        </button>
      </motion.div>
